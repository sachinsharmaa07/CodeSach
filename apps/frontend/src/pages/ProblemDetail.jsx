                ...
                <div className="space-y-3">
                  ...
                  {problem.examples.map((ex, i) => (
                    ...
                    >
                      ...
                      {ex.explanation && (
                        <div style={{ color: 'var(--color-text-muted)' }} className="text-[11px]">
                          💡 {ex.explanation}
                        </div>
                      )}
                    </div>
            ...
            <div className="space-y-3">
              ...
              {!running && !submitting && !results && (
                <div className="flex flex-col items-center justify-center gap-3 py-12 text-center">
                  <Terminal size={32} style={{ color: 'var(--color-text-muted)', opacity: 0.4 }} />
                          ...
                          {r.error ? (
                            ...
                            <>
                              ...
                              <div>
                                ...
                                <span className="text-red-400">{r.actual || '(no output)'}</span>
                              </div>
                            </>
                          )}
                        </div>
