...
export const AdminSubmissions = () => {
  ...
  useEffect(() => {
    setLoading(true);
    adminApi
      .submissions({ page, ...(statusFilter ? { status: statusFilter } : {}) })
      .then((res) => {
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        >
          ...
          <option value="accepted" className="bg-[#1a1a1a]">
            Accepted
          </option>
          <option value="wrong_answer" className="bg-[#1a1a1a]">
            Wrong Answer
          </option>
          <option value="compile_error" className="bg-[#1a1a1a]">
            Compile Error
          </option>
          <option value="runtime_error" className="bg-[#1a1a1a]">
            Runtime Error
          </option>
        </select>
      </div>
